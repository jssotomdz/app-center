...
import 'dino_game/cactus.dart';
import 'dino_game/cloud.dart';
import 'dino_game/constants.dart';
import 'dino_game/dino.dart';
import 'dino_game/game_object.dart';
import 'dino_game/ground.dart';
      ...
      children.add(
        AnimatedBuilder(
          ...
          builder: (context, _) {
            ...
            return Positioned(
              left: objectRect.left/3,
              top: objectRect.top/3,
              width: objectRect.width/3,
              height: objectRect.height/3,
              child: object.render(),
            );
          },
        ),
